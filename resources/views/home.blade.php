...
<head>
  ...
  <link rel="icon" href="https://cipcargo.uz/project/image/MT.png" type="image/gif" sizes="16x16">

  <title>Cipcargo.uz</title>
...
<body>
  ...
  <div class="wrapper overflow-x-hidden bg-[#690001] min-h-screen w-full relative">
    ...
    <div class="absolute top-0 bottom-0 left-0 right-0 ">
      <div class="container ">
        <section class="flex flex-col items-center justify-between min-h-screen login py-[10%] md:py-0">
          ...
          <div class="w-full px-4 py-6 bg-white rounded-lg sm:px-6 sm:py-12 md:w-3/4 lg:w-1/2 login__content z-1 ">
            <div class="pb-4 text-center sm:pb-6 login__title">
              <h2 class="mb-[10px] md:mb-4 text-xl  font-bold  md:text-3xl lg:text-4xl">YUK HOLATINI TEKSHIRISH</h2>
              <p id="text" class="text-[#918989] text-base ">
            ...
            <div class="flex items-center justify-center  space-x-1  md:space-x-4 md:flex-row flex-col space-y-4 md:space-y-0" >
              <input type="text" name="" id="search" placeholder="Shtrix raqam yoki ID raqam kiriting!" class=" w-full md:w-3/4 p-3 bg-[#F2F0F0] text-[#C8C8C8] rounded-lg border border-[#F2F0F0] text-black text-[16px] md:text-md">
              <button class="w-1/4 px-2 md:px-8 py-3 text-white duration-100 bg-green-500 rounded-lg w-full hover:bg-green-600 active:bg-green-600 text-[16px] md:text-md" id="search_submit">
                Izlash
              </button>
            </div>
          </div>
          <div class="pb-5 text-center">
            <div class="flex items-center justify-center w-full mt-4 space-x-4">
              <a href="https://instagram.com/cip_cargo/" class="w-8 h-8 md:w-10 md:h-10 duration-200 fill-white hover:fill-green-600" target="_blank">
              ...
              <a href="https://t.me/cip_cargo" class="w-8 h-8 md:w-10 md:h-10 duration-200 fill-white hover:fill-green-600" target="_blank">
               ...
               <a href="tel:+998330055100" class="w-8 h-8 md:w-10 md:h-10 duration-200 fill-white hover:fill-green-600" >
            ...
            <a class='text-white mt-4 md:mt-8 block text-[16px] md:text-base' href="https://abduganiev.uz" target="_blank">Websayt ishlab chiquvchi - ABDUGANIEV TECHNOLOGY</a>
          </div>
        </section>
      </div>
    </div>
